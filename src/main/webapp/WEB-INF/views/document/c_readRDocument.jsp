...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4" style="min-width: 850px;">반려한 문서</h2>
        <hr style="min-width: 850px;">
        <form method="post" id="searchform">
            <div class="search pb-2" style="min-width: 850px;">
                <div class="row">
...
<script>
    ...
    function fn_btnsearch(){
        ...
        $.ajax({
            url:"/restdocument/searchRdocument.document",
            type:"post",
            data:data,
